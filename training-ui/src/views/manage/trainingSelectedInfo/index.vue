  ...
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="trainingSelectedInfoList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="选择编号" align="center" v-if="columns[0].visible" prop="selectedId" />
        <el-table-column label="实训" :show-overflow-tooltip="true" align="center" v-if="columns[1].visible" prop="trainingId" />
        <el-table-column label="报告内容" :show-overflow-tooltip="true" align="center" v-if="columns[2].visible" prop="content" />
        ...
        <el-table-column label="评分" :show-overflow-tooltip="true" align="center" v-if="columns[6].visible" prop="score" />
        <el-table-column label="评语" :show-overflow-tooltip="true" align="center" v-if="columns[7].visible" prop="comment" />
        ...
        <el-table-column label="老师" :show-overflow-tooltip="true" align="center" v-if="columns[9].visible" prop="teacherId" />
        <el-table-column label="学生" :show-overflow-tooltip="true" align="center" v-if="columns[10].visible" prop="userId" />
        <el-table-column label="班级" :show-overflow-tooltip="true" align="center" v-if="columns[11].visible" prop="deptId" />
        <el-table-column label="创建时间" align="center" v-if="columns[12].visible" prop="createTime" width="180">
        <template slot-scope="scope">
          <span>{{ parseTime(scope.row.createTime, '{y}-{m}-{d}') }}</span>
        </template>
      </el-table-column>
        <el-table-column label="更新人" :show-overflow-tooltip="true" align="center" v-if="columns[13].visible" prop="updatedBy" />
...
<script>
import { listTrainingSelectedInfo, getTrainingSelectedInfo, delTrainingSelectedInfo, addTrainingSelectedInfo, updateTrainingSelectedInfo } from "@/api/manage/trainingSelectedInfo";
