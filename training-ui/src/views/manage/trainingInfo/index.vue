  ...
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="trainingInfoList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="实训编号" align="center" v-if="columns[0].visible" prop="trainingId" />
        <el-table-column label="实训标题" :show-overflow-tooltip="true" align="center" v-if="columns[1].visible" prop="trainingTitle" />
        <el-table-column label="实训描述" :show-overflow-tooltip="true" align="center" v-if="columns[2].visible" prop="trainingDesc" />
        ...
        <el-table-column label="班级" :show-overflow-tooltip="true" align="center" v-if="columns[5].visible" prop="deptId" />
        <el-table-column label="创建时间" align="center" v-if="columns[6].visible" prop="createTime" width="180">
        <template slot-scope="scope">
          <span>{{ parseTime(scope.row.createTime, '{y}-{m}-{d}') }}</span>
        </template>
      </el-table-column>
        <el-table-column label="更新人" :show-overflow-tooltip="true" align="center" v-if="columns[7].visible" prop="updatedBy" />
...
<script>
import { listTrainingInfo, getTrainingInfo, delTrainingInfo, addTrainingInfo, updateTrainingInfo } from "@/api/manage/trainingInfo";
