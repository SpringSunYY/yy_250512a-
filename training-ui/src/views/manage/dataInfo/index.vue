<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="dataInfoList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="资料标题" :show-overflow-tooltip="true" align="center" v-if="columns[1].visible"
                       prop="dataTitle"
      />
      <el-table-column label="资料描述" :show-overflow-tooltip="true" align="center" v-if="columns[2].visible"
                       prop="dataDesc"
      />
      ...
      <el-table-column label="创建人" :show-overflow-tooltip="true" align="center" v-if="columns[4].visible"
                       prop="userName"
      />
      <el-table-column label="院系" :show-overflow-tooltip="true" align="center" v-if="columns[5].visible"
                       prop="deptName"
      />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="资料文件" prop="dataFile">
          <file-upload :limit="1" v-model="form.dataFile"/>
        </el-form-item>
        <!--        <el-form-item label="创建人" prop="userId">-->
...
export default {
  ...
  data() {
    return {
      ...
      //表格展示列
      columns: [
        { key: 0, label: '资料编号', visible: false },
