<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="班级标题" prop="className">
        <el-input
...
<!--      </el-form-item>-->
      <el-form-item label="" prop="deptId" style="width: 25%">
        <el-row :gutter="24">
          <el-col :span="6">
            <span style=" font-weight: bold;color: rgb(96, 98, 102)">所属学院</span>
          </el-col>
          <el-col :span="18">
            <treeselect v-model="queryParams.deptId"
                        :options="deptOptions" :show-count="true" :normalizer="normalizer" placeholder="请选择所属学院"
...
<!--      </el-form-item>-->
    ...
    <el-table v-loading="loading" :data="classInfoList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="班级标题" :show-overflow-tooltip="true" align="center" v-if="columns[1].visible"
                       prop="className"
      />
      <el-table-column label="班级描述" :show-overflow-tooltip="true" align="center" v-if="columns[2].visible"
                       prop="classDesc"
      />
      <el-table-column label="创建人" :show-overflow-tooltip="true" align="center" v-if="columns[3].visible"
                       prop="userName"
      />
      <el-table-column label="学院" :show-overflow-tooltip="true" align="center" v-if="columns[4].visible"
                       prop="deptName"
      />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="班级标题" prop="className">
          <el-input v-model="form.className" placeholder="请输入班级标题"/>
        </el-form-item>
...
export default {
  ...
  data() {
    return {
      ...
      //表格展示列
      columns: [
        { key: 0, label: '班级编号', visible: false },
        { key: 1, label: '班级标题', visible: true },
        { key: 2, label: '班级描述', visible: true },
      ...
      rules: {
        className: [
          { required: true, message: '班级标题不能为空', trigger: 'blur' }
        ],
        classDesc: [
          { required: true, message: '班级描述不能为空', trigger: 'blur' }
        ],
        userId: [
